...
export class VerdictService {
  ...
  private CorrectConceedPrompts: string[] = [
    "Why thank you",
    "Yes, yes, move on",
    "Well, duh",
    "Uh-huh.",
  ...
  private IncorrectHeaders: string[] = [
    "You is wrong",
    "You is dumb",
    "DAAAAANNG",
    ...
    "Thou art unsmartified",
    "You FOOL",
    "Mental Midget.",
    "You're a real turnip, aren't you?",
    "Child.  (*scoff*)"
  ];
  ...
  private IncorrectConceedPrompts: string[] = [
    "I'm Dumb",
    "I conceed my stupidity",
    "I'll be less dumb next time",
    "Sorry.",
    "wubba lubba dub dub?",
    "was I that far off?",
    "I know...",
